...
vault. Do not write any notes — your only deliverable is the unit map.
...
1. Read {outline} — the book's structure: every H1 heading with its pdf
   ...
   {page_offset}.
2. Read {vault}/_meta/conventions.md for the note and MOC policies.
3. List {vault}/_index/ to see the MOC names that already exist.
